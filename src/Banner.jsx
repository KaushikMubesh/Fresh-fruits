...
const Banner = () => {
  return (
    <section className='flex justify-end gap-8 bg-secondary/20 p-[40px]'>
      <div className='container grid md:grid-cols-2 items-center '>
        <div>
          <img
          src={Image9} alt="" className='w-[300px] transform translate-x-[210px] h-full object-cover scale-125' />
        </div>
        <div>
          <div>
            <motion.h1
